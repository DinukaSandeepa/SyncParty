...
export default function Header() {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-50 border-b bg-black/80 backdrop-blur-xl border-white/10">
            <div className="max-w-6xl mx-auto">
                <div className="flex items-center justify-between h-16">
                    {/* Logo */}
                    <div className="flex items-center gap-3">
                        <svg className="w-32 sm:w-36" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 1524 322">
                    ...
                    <div className="flex items-center gap-4">
                        <SignedOut>
                            <div className="flex items-center gap-2">
                                <SignInButton mode="modal">
                                    <button className="px-4 py-2 text-sm font-medium transition-colors text-white/80 hover:text-white">
                                        Sign In
                                    </button>
                                </SignInButton>
                                <SignUpButton mode="modal">
                                    <button className="px-4 py-2 text-sm font-medium text-black transition-colors bg-white rounded-lg hover:bg-white/90">
                                        Sign Up
                                    </button>
                                </SignUpButton>
                            </div>
                        ...
                        <SignedIn>
                            <div className="flex items-center gap-3">
                                {isLoaded && user && (
                                    <div className="items-center hidden gap-3 mr-2 sm:flex">
