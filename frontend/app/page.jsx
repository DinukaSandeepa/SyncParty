  ...
  return (
    <main className="min-h-screen bg-black text-white p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white/5 rounded-xl p-6 mb-6 border border-white/5 animate-fade-in-up delay-100 hover:border-white/20 transition-all duration-300">
          ...
          <div className="flex gap-3">
            <input
              ...
              disabled={isInRoom}
              className="flex-1 px-4 py-2 bg-white/10 border border-white/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-white disabled:opacity-50 transition-all duration-300 hover:bg-white/15"
            />
            <button
              onClick={handleJoinRoom}
              disabled={isInRoom || !room.trim()}
              className="px-6 py-2 bg-white text-black hover:bg-white/80 disabled:bg-white/20 disabled:text-white/40 disabled:cursor-not-allowed rounded-lg font-medium transition-all duration-300 hover:scale-105 active:scale-95"
            >
        ...
        {/* File Inputs */}
        <div className="bg-white/5 rounded-xl p-6 mb-6 border border-white/5 animate-fade-in-up delay-200 hover:border-white/20 transition-all duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 bg-white/10 border border-white/30 rounded-lg file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:bg-white file:text-black hover:file:bg-white/80 file:cursor-pointer transition-all duration-300 hover:bg-white/15"
              />
            </div>
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 bg-white/10 border border-white/30 rounded-lg file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:bg-black file:text-white hover:file:bg-black/80 file:cursor-pointer file:border file:border-white/30 transition-all duration-300 hover:bg-white/15"
              />
            </div>
          </div>
        </div>
        ...
        {/* Video Player */}
        {videoFile && (
          <div className="bg-white/5 rounded-xl p-6 mb-6 border border-white/5 animate-fade-in-up delay-300 hover:border-white/20 transition-all duration-300">
            <h2 className="text-xl font-semibold mb-4">Video Player</h2>
            <div className="relative bg-black rounded-lg overflow-hidden shadow-2xl transition-shadow duration-300 hover:shadow-white/10">
              <video
                ref={videoRef}
                src={videoFile}
        ...
        {/* Subtitle Controls */}
        {subtitleFile && (
          <div className="bg-white/5 rounded-xl p-6 mb-6 border border-white/5 animate-fade-in-up delay-400 hover:border-white/20 transition-all duration-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full h-2 bg-white/20 rounded-lg appearance-none cursor-pointer accent-white transition-all duration-300 hover:bg-white/30"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full h-2 bg-white/20 rounded-lg appearance-none cursor-pointer accent-gray-400 transition-all duration-300 hover:bg-white/30"
                />
              </div>
            </div>
          </div>
        ...
        {/* Status Log */}
        <div className="bg-white/5 rounded-xl p-6 border border-white/5 animate-fade-in-up delay-500 hover:border-white/20 transition-all duration-300">
